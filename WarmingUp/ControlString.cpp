...
void CS::StringReverse(list<string>& text)
{
...
void CS::Insert(list<string>& text, int interval, string symbol, bool& isInsert)
{
    list<string> copyText;
    string line;
    int count = 0;
...
void CS::SpaceStandardReverse(list<string>& text, string symbol, bool isInsert)
{
    list<string> copyText;
...
void CS::ChangeCharacter(list<string>& text, string searchWord, string changeWord)
{
    list<string> copyText;
    string line;
...
void CS::FIndSameWordFrontOfBack(list<string>& text)
{
    string front;
    string back;
    string line;
